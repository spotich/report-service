...
const (
	Timer_GetTime_FullMethodName = "/timer.Timer/GetTime"
)
...
type TimerClient interface {
	GetTime(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error)
}
...
func (c *timerClient) GetTime(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, Timer_GetTime_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TimerServer interface {
	GetTime(context.Context, *GetRequest) (*GetResponse, error)
...
func (UnimplementedTimerServer) GetTime(context.Context, *GetRequest) (*GetResponse, error) {
...
func _Timer_GetTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Timer_GetTime_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TimerServer).GetTime(ctx, req.(*GetRequest))
	}
