...
func (c *timerClient) GetTime(ctx context.Context, in *TimeRequest, opts ...grpc.CallOption) (*TimeResponse, error) {
...
func (UnimplementedTimerServer) GetTime(context.Context, *TimeRequest) (*TimeResponse, error) {
...
func _Timer_GetTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TimerServer).GetTime(ctx, req.(*TimeRequest))
	}
